...
const LaporanSelesai = () => {
    ...
    const fetchLaporan = async () => {
        ...
        try {
            const response = await fetch('http://localhost:3001/API/manajer/laporan-marketers/valid', {
                method: 'GET',
                headers: {
                                                                ...
                                                                <div className="col-lg-8">
                                                                    ...
                                                                    <div className="row">
                                                                        ...
                                                                        <div className="col-md-6">
                                                                            <div className="laporan-detail-section">
                                                                                <h6 className="laporan-detail-title">
                                                                                    <i className="bi bi-check-circle me-2"></i>Waktu Diverifikasi
                                                                                </h6>
                                                                                <p className="laporan-detail-text">{formatDate(item.waktu_diverifikasi)}</p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div className="laporan-detail-section">
